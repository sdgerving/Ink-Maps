...
Public Class Calendar
    ...
    Public Sub DrawnCalendar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For i As Integer = 0 To 41
            ...
            End If
        Next
        If hourplan.closetag = 1 Then
            artist = hourplan.artist

        Else
            saveinfo2(0) = artistselect.saveinfo2(0)
        saveinfo2(1) = artistselect.saveinfo2(1)
        saveinfo2(2) = artistselect.saveinfo2(2)
        saveinfo2(3) = artistselect.saveinfo2(3)
        saveinfo2(4) = artistselect.saveinfo2(4)
        saveinfo2(5) = artistselect.saveinfo2(5)
        saveinfo2(6) = artistselect.saveinfo2(6)
        saveinfo2(7) = artistselect.saveinfo2(7)
        saveinfo2(8) = artistselect.saveinfo2(8)
        saveinfo2(9) = artistselect.saveinfo2(9)
        saveinfo2(10) = artistselect.saveinfo2(10)
        saveinfo2(11) = artistselect.saveinfo2(11)
        saveinfo2(12) = artistselect.saveinfo2(12)
        saveinfo2(13) = artistselect.saveinfo2(13)
        saveinfo2(14) = artistselect.saveinfo2(14)
        saveinfo2(15) = artistselect.saveinfo2(15)
        saveinfo2(16) = artistselect.saveinfo2(16)
        saveinfo2(17) = artistselect.saveinfo2(17)
        saveinfo2(18) = artistselect.saveinfo2(18)
        saveinfo2(19) = artistselect.saveinfo2(19)
        saveinfo2(20) = artistselect.saveinfo2(20)
        saveinfo2(21) = artistselect.saveinfo2(21)
        saveinfo2(22) = artistselect.saveinfo2(22)
        saveinfo2(23) = artistselect.saveinfo2(23)
        saveinfo2(24) = "0"
        saveinfo2(25) = "0"
        saveinfo2(26) = "0"
            saveinfo2(27) = "0"
    ...
    Private Sub DirSearch()
        ...
        If artist = 1 Then
            strDir = "c:\appointment\paullunetta"
        End If
        If artist = 2 Then
            strDir = "c:\appointment\jazminwebb"
        End If
        If artist = 3 Then
            strDir = "c:\appointment\coltrichardson"
        End If
    ...
    Private Sub populatecalendar()
        ...
        If monthvar < 1 Or monthvar > 12 Then
            monthvar = 1
        End If
        If monthvar = 1 Then
            monthtext = "January"
